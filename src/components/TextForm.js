...
export default function TextForm(props){
    ...
    return(
        ...
        <button className='btn-btn-primary mx-2 my-2' onClick={handleWordRank}>Word Rank</button>

        </div>
        <div className='container my-3' style={{color : props.mode === 'dark' ? 'white' : '#042743'}}>
            <h1>Text summary</h1>
            <p>Characters: {text.length}, words: {text.split(" ").filter((element)=> {return element.length!== 0}).length} </p>
